...
describe("RunsPage", () => {
  it("lists runs newest-first with detail links", async () => {
    stubFetch(() => [
      { run_id: "r2", status: "done", needs_approval: false, events_count: 5, error: null, mode: "research" },
      { run_id: "r1", status: "awaiting_approval", needs_approval: true, events_count: 3, error: null, mode: "brainstorm" },
    ]);
    render(<RunsPage />);
